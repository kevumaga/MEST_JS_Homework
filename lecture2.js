 ...
 *  Response: It will output the windows object on the console because the this method points to the parent object which in this case is the window object.
 * 
 * 
 *  var obj = {
 ...
 *  Response:  Will print the obj  object because 'this' in the function 'func' now points to the obj object not the windows object

 * 
 * 
 *  obj.func.bind(window)(); // what is the output? why?
 *  Response: It will display the windows object because the function 'func' is now bound to the windows object and not 'obj' object
 *
 *  obj.func.bind(this)();  // what is the output? why?
 *  Response: It prints out the windows object because 'this' binds the 'func' to the windows object
 * 
 *  var people = {
 *      name: 'ashwin',
 *      age: 40
 ...
 */
   // Response:t This will print out the 'people' object because 'func' is now bound to 'people' objec
...
Before HTML5,application data had to be stored in cookies,including in every server request. It is more secure,
and large amounts of data can be stored locally,without affecting website performance. localStorageis per origin.
All pages from one origin, can store and access the same data.

The sessionStorge object is equal to the localStorage object, EXCEPT that it stores when the user closes the specificthe data is deleted whenthe user closes the specific browser.
